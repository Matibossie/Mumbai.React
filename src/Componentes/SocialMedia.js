...
function SocialMedia() {
    return (
    <>    
           <div className="icon"><NavLink target="_blank"  rel="noreferrer" href="https://www.instagram.com/mumbai.cuadros/"><img className="icon-social" src={Instagram} alt="logo-instagram" /></NavLink></div>
